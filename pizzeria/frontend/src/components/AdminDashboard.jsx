  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "#050816", py: { xs: 3, md: 5 } }}>
      <Container maxWidth={false} sx={{ px: { xs: 2, sm: 3, md: 5 } }}>
        ...
        {/* WORKSPACE OPERATIONS GRID - BOTH SECTIONS TIED IN A SINGLE HORIZONTAL ROW IN WEB VIEW */}
        <Grid 
          container 
          spacing={3} 
          sx={{ 
        ...
        >
          {/* COLUMN 1: ADD MENU & ACTIVE MENU ITEMS (Locks 50% width on Desktop viewports) */}
          <Grid 
            item 
            xs={12} 
            md={6} 
